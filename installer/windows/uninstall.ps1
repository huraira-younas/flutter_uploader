<# .SYNOPSIS
    Uninstall Flutter Uploader via its Inno Setup registry entry.
.DESCRIPTION
    Looks up the uninstall command in the Windows registry and invokes it.
    Use -Silent for a quiet uninstall.
.EXAMPLE
